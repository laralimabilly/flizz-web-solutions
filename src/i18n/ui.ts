...
const en = {
  ...
  servicePage: {
    ...
    deliverablesEyebrow: 'What lands in your hands',
    faqEyebrow: 'Answers upfront',
    faqTitle: 'QUESTIONS',
    otherEyebrow: 'Keep exploring',
    otherTitle: 'OTHER SERVICES',
    learnMore: 'Full service details',
    startCta: 'Start this project',
    close: 'Close',
  },
  projectDetail: {
    back: 'Back to work',
...
const pt: UI = {
  ...
  servicePage: {
    ...
    eyebrowPrefix: 'Serviço',
    pillarsEyebrow: 'O que você recebe',
    pillarsTitle: 'OS PILARES',
    processEyebrow: 'Como trabalhamos',
    processTitle: 'O PROCESSO',
    deliverablesEyebrow: 'O que chega às suas mãos',
    faqEyebrow: 'Respostas na frente',
    faqTitle: 'PERGUNTAS',
    otherEyebrow: 'Continue explorando',
    otherTitle: 'OUTROS SERVIÇOS',
    learnMore: 'Detalhes do serviço',
    startCta: 'Iniciar este projeto',
    close: 'Fechar',
  },
  projectDetail: {
